...
# mdm_inventory/
APPS_DIR = ROOT_DIR / "mdm_inventory"
env = environ.Env()
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "mdm_inventory.utils.context_processors.settings_context",
            ],
        },
    }
]
...
ADMINS = [("""Leonel M , Luis A , Jose M""", "laduney1234@gmail.com")]
...
# https://django-allauth.readthedocs.io/en/latest/configuration.html
ACCOUNT_ADAPTER = "mdm_inventory.users.adapters.AccountAdapter"
# https://django-allauth.readthedocs.io/en/latest/configuration.html
SOCIALACCOUNT_ADAPTER = "mdm_inventory.users.adapters.SocialAccountAdapter"
